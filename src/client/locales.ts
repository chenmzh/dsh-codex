...
export const en = {
  ...
  deviceCodeInstructions: 'Open the ChatGPT device page on any signed-in device, then enter this one-time code.',
  ...
  responseApiIntro: 'These settings affect OpenAI Codex requests only. Existing conversations remain readable when a setting changes.',
  reasoningSummary: 'Reasoning summary',
  reasoningSummaryHint: 'Requests a provider-authored summary. Detailed can explain more, but it is not the model\'s private raw chain-of-thought.',
